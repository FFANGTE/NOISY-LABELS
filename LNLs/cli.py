...
# lr schedule
parser.add_argument('--c', default=80, type=int, help='interval of lr cycle')
...
# parser.add_argument('--swa', default=False, type=bool, help='generate swa model')
# parser.add_argument('--fastswa', default=True, type=bool, help='generate fast swa model')
